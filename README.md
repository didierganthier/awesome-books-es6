...
> In this project, I will restructure the Awesome books app code. The goal is to make it more organized by using modules. The goal is to practice the ES6 syntax.
